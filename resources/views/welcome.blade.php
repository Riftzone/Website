...
<head>
    ...
    <meta name="keywords" content="Riftzone, Streamer, Youtuber">
            ...
            <div class="all-projects">
                <div class="project-item">
                    <div class="project-info">
                        <h1><a href="https://www.twitch.tv/riftzone" target="_blank">
                                <font color=purple><B>Twitch</B></font>
                            </a>
                        </h1>
                        <h2>Aufgaben auf Twitch</h2>
                        <p>Riftzone versucht so oft es nur geht zu streamen und euch mit diesen zu unterhalten.
                            Hierbei reagiert er mit euch auf Videos/Clips oder spielt jegliche Games, auf die er gerade
                            so
                            Lust hat</p>
                    </div>
                ...
                <div class="project-item">
                    <div class="project-info">
                        <h1><a href="https://www.youtube.com/channel/UCVZmhmDtF8wCHNqpviNsAlw" target="_blank">
                                <font color=red><B>Youtube</B></font>
                            </a></h1>
                ...
                <div class="project-item">
                    <div class="project-info">
                        <h1><a href="https://www.tiktok.com/@riftzoneyt?lang=de-DE" target="_blank">
                                <font color=cyan><B>Tiktok</B></font>
                            </a>
                        </h1>
                        <h2>Aufgaben auf Tiktok</h2>
                        <p>Riftzone lädt auf seinem Tiktok Account jegliche OmeTV Clips hoch, die sowohl in seinen
                            Youtube
                ...
                <div class="project-item">
                    <div class="project-info">
                        <h1>
                            <a href="https://dc.riftzone.me/" target="_blank">
                                <font color=blue><B>Discord</B></font>
                            </a>
                        </h1>
    ...
    <section id="about">
        <div class="about container">
            ...
            <div class="col-right">
                ...
                <p>Im Wesentlichen steht Riftzone natürlich im Vordergrund, wenn es um Social Media und weitere
                    Promotion
                    geht.
                    Das Team kümmert sich im Hintergrund währenddessen um die Moderation, Administration und Planung von
                    Community
                    Projekten. Diese Projekte werden zusammen mit der Community gestaltet und insbesondere so geplant,
                    dass
                    jeder
                    was von diesen hat.
                    <br><br>
